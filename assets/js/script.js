document.addEventListener("DOMContentLoaded", function () {
  ...
  Dashboard.addEventListener("click", function (event) {
    ...
    content.innerHTML = `<section class="max-w-7xl mx-auto py-4 px-5">
  ...
  classDiv.addEventListener("click", function (event) {
    ...
    content.innerHTML = ` <div class="class w-full bg-gray-200 p-10">
              <nav class="w-full py-6">
                <a id="classList" class="text-lg text-white hover:bg-purple-600/80 bg-purple-600 p-1" href="#">Class List</a>
                <a id="Addclass" class="text-lg text-white hover:bg-purple-600/80 bg-purple-600 p-1" href="#">Add class</a>
              </nav>
  ...
  settingsLink.addEventListener("click", function (event) {
    event.preventDefault();
    content.innerHTML =
      "<h2>Settings Page Content</h2><p>Modify your settings here.</p>";
  });
});
